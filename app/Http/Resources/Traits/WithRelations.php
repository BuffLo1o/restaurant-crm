...
trait WithRelations
{
     ...
     * @var array{responseKey: string, array{relation: string, resource: class-string<self>, withRelations: array}}
     */
     ...
     *
     * @param  array{responseKey: string, array{relation: string, resource: class-string<self>, withRelations: array}}  $relations
     * @return $this
     */
    public function withRelations(array $relations): self
    {
        ...
        } else if (in_array(WithRelations::class, class_uses_recursive($this->collects))) {
